                ...
                <div class="game-sidebar">
                    ...
                    <div class="developer-actions">
                        ...
                        <div class="action-buttons">
                            ...
                            <form action="delete_fangame.php" method="POST" style="display: inline;">
                                <input type="hidden" name="game_id" value="<?php echo $gameId; ?>">
                                <button type="submit" class="action-btn delete" onclick="return confirm('Tem certeza que deseja excluir este fangame? Esta ação não pode ser desfeita.')">
